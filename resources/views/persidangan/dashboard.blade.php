...
<body class="bg-gray-100">
  ...
  <script>
    // Dropdown
    const uraianOptions = {
      penyusunan_pembahasan_progbangperda: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Makanan dan Minuman Rapat", "Belanja Jasa Kontribusi Asosiasi", "Belanja Sewa Kendaraan Bermotor Penumpang", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"],
      pembahasan_ranperda: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Makanan dan Minuman Rapat", "Honorarium Narasumber...", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota", "Belanja Perjalanan Dinas Paket Meeting Dalam Kota", "Belanja Jasa yang Diberikan kepada Pihak Ketiga/Pihak Lain"],
      kajian_perundang_undangan: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Makanan dan Minuman Rapat", "Belanja Jasa Tenaga Ahli", "Belanja Sewa Kendaraan Bermotor Penumpang", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"],
      fasilitasi_penyusunan_naskah_akademik: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Makanan dan Minuman Rapat", "Belanja Jasa Konsultansi Berorientasi Layanan-Jasa Studi Penelitian dan Bantuan Teknik", "Belanja Perjalanan Dinas Dalam Kota"],
      penyusunan_tata_tertib_dprd: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Makanan dan Minuman Rapat", "Belanja Sewa Kendaraan Bermotor Penumpang", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"],
      hubungan_masyarakat: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Jasa Tenaga Supir", "Belanja Jasa Iklan/Reklame, Film, dan Pemotretan", "Belanja Sewa Kendaraan Bermotor Penumpang", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"],
      publikasi_dokumentasi_dprd: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Honorarium Narasumber atau Pembahas...", "Belanja Jasa Iklan/Reklame, Film, dan Pemotretan", "Belanja Langganan Jurnal/Surat Kabar/Majalah", "Belanja Sewa Kendaraan Bermotor Penumpang", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"],
      koordinasi_konsultasi_tugas_dprd: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Sewa Kendaraan Bermotor Penumpang", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"],
      fasilitasi_tugas_bamus: ["Belanja Alat/Bahan untuk Kegiatan Kantor-Alat Tulis Kantor", "Belanja Makanan dan Minuman Rapat", "Belanja Perjalanan Dinas Biasa", "Belanja Perjalanan Dinas Dalam Kota"]
    };
