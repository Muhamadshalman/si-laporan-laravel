...
@if(session('role') === 'superadmin')
          <a href="{{ route('dashboard.validasi', 'fasilitasi') }}" class="group w-full text-left px-4 py-3.5 rounded-xl hover:bg-gray-700/50 transition-all duration-200 font-medium flex items-center gap-3 relative overflow-hidden">
          ...
          <a href="{{ route('dashboard.cetak', 'fasilitasi') }}" class="group w-full text-left px-4 py-3.5 rounded-xl hover:bg-gray-700/50 transition-all duration-200 font-medium flex items-center gap-3 relative overflow-hidden mt-2">
...
@else
          ...
          <button onclick="showRiwayat()" id="btn-riwayat" class="group w-full text-left px-4 py-3.5 rounded-xl hover:bg-gray-700/50 transition-all duration-200 font-medium flex items-center gap-3 relative overflow-hidden mt-2">
        ...
        <div class="bg-gradient-to-br from-blue-600/20 to-indigo-600/20 backdrop-blur-sm border border-blue-500/30 rounded-xl p-4 mt-auto">
          <div class="flex items-center gap-3 mb-3">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs text-blue-300">Bagian Fasilitasi</p>
            </div>
          </div>
    ...
    <main class="flex-1 overflow-y-auto">
      <div class="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 pb-24 md:pb-8">
        ...
        <section id="upload-section" class="hidden">
          @include('fasilitasi.upload')
        </section>

        <!-- RIWAYAT SECTION -->
        <section id="riwayat-section" class="hidden">
          @include('fasilitasi.riwayat')
        </section>
...
@if(session('role') === 'superadmin')
      <a href="{{ route('dashboard.validasi', 'fasilitasi') }}" class="flex-1 flex flex-col items-center justify-center py-3 transition-all duration-200 relative">
      ...
      <a href="{{ route('dashboard.cetak', 'fasilitasi') }}" class="flex-1 flex flex-col items-center justify-center py-3 transition-all duration-200 relative">
...
@endif
  ...
  <script src="{{ asset('js/fasilitasi/uraian-options.js') }}"></script>
  <script src="{{ asset('js/fasilitasi/form-handlers.js') }}"></script>
  <script src="{{ asset('js/fasilitasi/ui-handlers.js') }}"></script>
  <script src="{{ asset('js/fasilitasi/app.js') }}"></script>
